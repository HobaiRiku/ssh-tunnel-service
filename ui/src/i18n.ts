  ...
  en: {
    ...
    tunnels: {
      ...
      direction: {
        ...
        localTargetMeaning: 'Target = host:port the remote will connect to.',
        remoteTitle: 'Remote forward',
        remoteSummary: 'Expose a local service on the remote machine.',
        remoteBindMeaning: 'Bind = address/port the remote listens on.',
        remoteTargetMeaning: 'Target = host:port this machine will connect to.',
      },
    },
    remotes: {
      title: 'Remotes',
  ...
  'zh-CN': {
    ...
    tunnels: {
      ...
      direction: {
        ...
        localTargetMeaning: '目标 = 远端机器要连接的主机和端口。',
        remoteTitle: '远程转发',
        remoteSummary: '把本地服务暴露到远端机器。',
        remoteBindMeaning: '监听 = 远端机器监听的地址/端口。',
        remoteTargetMeaning: '目标 = 当前机器要连接的主机和端口。',
      },
    },
    remotes: {
      title: '远端',
